...
function IntegrationsContent() {
  ...
  const integrations: Integration[] = [
    ...
    },
    {
      ...
      description: 'Send automated SMS alerts for payments, reminders, and updates.',
      icon: MessageSquare,
      status: 'disconnected',
      ...
      pricing: 'KES 0.50 per SMS',
      docs: 'https://africastalking.com/docs'
    },
    {
      id: 'email-automation',
      name: 'Email Automation',
      description: 'Automated email campaigns, reports, and notifications.',
      icon: Mail,
      status: 'disconnected',
      category: 'communication',
      features: [
      ...
      pricing: 'Free up to 1,000 emails/month',
      docs: 'https://sendgrid.com/docs'
    },
    {
      id: 'whatsapp-business',
      name: 'WhatsApp Business API',
      description: 'Customer support, booking confirmations, and automated responses.',
      icon: MessageSquare,
      status: 'disconnected',
      category: 'communication',
      features: [
