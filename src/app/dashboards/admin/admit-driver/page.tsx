      ...
      <div className="sticky top-0 z-30 bg-slate-900/90 backdrop-blur-xl border-b border-yellow-500/20">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center gap-4">
            {/* Fixed: Back button now goes to /dashboards/admin/drivers (plural) */}
            <Link
      ...
      <div className="max-w-4xl mx-auto px-6 py-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div className="bg-slate-800/50 backdrop-blur-sm border border-yellow-500/20 rounded-2xl overflow-hidden">
            ...
            <div className="p-6">
              ...
              <div className="relative">
                ...
                {/* Vehicle Dropdown - Enhanced with more vehicle details */}
              ...
              {/* Selected Vehicle Info - Enhanced */}
              {selectedVehicle && (
          ...
          <div className="flex justify-end gap-3">
            ...
            <button
              type="submit"
              disabled={loading || vehiclesLoading || !selectedVehicle}
